  ...
  return (
    <div className="container py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4">About {siteName}</h1>
      ...
      <div className="grid gap-12 lg:grid-cols-2 items-center mb-16">
        <div>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Founded in 2010, {siteName} started with a simple mission: to provide Pakistan with reliable power solutions. What began as a small shop in {settings.general.siteAddress?.split(",")[0] || "Lahore"} has grown into one of the country&apos;s most trusted generator suppliers.
            </p>
            <p>
