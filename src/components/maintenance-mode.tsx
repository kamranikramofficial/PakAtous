        ...
        <div className="text-center px-4">
          ...
          <div className="mx-auto mb-8">
            <svg
              ...
              className="text-yellow-400 mx-auto animate-pulse"
            >
            ...
            <div className="space-y-3 text-blue-100">
              {settings.general.sitePhone && (
                <p className="flex items-center justify-center gap-2">
                  ...
                  <a href={`tel:${settings.general.sitePhone}`} className="hover:text-white transition-colors">
                    {settings.general.sitePhone}
                  </a>
                </p>
              )}
              {settings.general.siteEmail && (
                <p className="flex items-center justify-center gap-2">
                  ...
                  <a href={`mailto:${settings.general.siteEmail}`} className="hover:text-white transition-colors">
                    {settings.general.siteEmail}
                  </a>
                </p>
              )}
